          ...
          <FadeInUpAnimation>
            <div className="services_content">
              ...
              <span className="services_button" onClick={() => toggleTab(1)}>
                View More{" "}
                <FaArrowRight className="viewmore_icon"></FaArrowRight>
              </span>
              ...
              >
                <div className="services_modal-content">
                  ...
                  <p className="services_modal-description">
                    ...
                    pixel-perfect, responsive UI designs. Proficient in React
                  ...
                  <ul className="services_modal-services grid">
                    <li className="services_modal-service">
                      ...
                      <p className="services_modal-info">
                        Craft pixel-perfect UIs for captivating user
                        experiences.
                      </p>
                    </li>
                    <li className="services_modal-service">
                    ...
                    <li className="services_modal-service">
                      <BiCaretRight className="services_modal-icon"></BiCaretRight>
                      <p className="services_modal-info">
                        Skilled in CSS,from custom styles to frameworks like BS5
                        and Tailwind.
                      </p>
                    </li>
                    <li className="services_modal-service">
                      <BiCaretRight className="services_modal-icon"></BiCaretRight>
                      <p className="services_modal-info">
                        Build dynamic apps using React.js for engaging
                        interfaces.
                      </p>
                    </li>
                    <li className="services_modal-service">
                      <BiCaretRight className="services_modal-icon"></BiCaretRight>
                      <p className="services_modal-info">
                        Capable of handling the entire development process
                    ...
                    <li className="services_modal-service">
                      <BiCaretRight className="services_modal-icon"></BiCaretRight>
                      <p className="services_modal-info">
                        Proficient in working with databases, including MySQL
                        and MongoDB.
                      </p>
                    </li>
                    <li className="services_modal-service">
            ...
            <div className="services_content">
              ...
              >
                <div className="services_modal-content">
                  ...
                  <p className="services_modal-description">
                    Proficient in graphic design, I craft captivating social
                    media banners, cover photos, and minimalist logos.
                  </p>
                  <ul className="services_modal-services grid">
                    <li className="services_modal-service">
                      <BiCaretRight className="services_modal-icon"></BiCaretRight>
                ...
                <div className="services_modal-content">
                  ...
                  <ul className="services_modal-services grid">
                    <li className="services_modal-service">
                      <BiCaretRight className="services_modal-icon"></BiCaretRight>
                      <p className="services_modal-info">
                        Proficient in running impactful social media ad
                        campaigns.
                      </p>
                    </li>
                    <li className="services_modal-service">
